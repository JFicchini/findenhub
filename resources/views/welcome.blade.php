...
<body
    class="bg-[#E6EDF4] dark:bg-[#0a0a0a] text-[#1E2A38] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-5xl max-w-[500px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-block px-5 py-1.5 dark:text-[#1E2A38] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                        Painel de Controle
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-1 dark:text-[#1E2A38] text-[#1E2A38] border border-transparent hover:text-[#AEB4BC] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal">
                        Acesse
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] hover:text-[#AEB4BC] text-[#1E2A38] rounded-sm text-sm leading-normal">
                            Cadastre-se
                        </a>
                    @endif
                @endauth
