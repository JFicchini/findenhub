...
<body class="font-sans antialiased text-[#1E2A38] bg-[#E6EDF4] flex flex-col min-h-screen">
    <div class="flex-1 flex flex-col bg-[#E6EDF4]">
        ...
        <!-- Footer -->
        <footer class="flex flex-col items-center text-sm text-center text-[#5A5F66] py-2 mt-8">
